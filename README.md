...
| `auth` | JWT de usuario **ES256** (kid + MultiVerifier) + service token M2M HS256 + RBAC glob + bcrypt + refresh opaco (tag `auth/v0.2.0`). | [README](auth/README.md) | [CHANGELOG](auth/CHANGELOG.md) |
